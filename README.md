...
- When the HTML button element with text content **Create my plan!** is clicked
  ...
  - If an option is not selected for any of the questions then following text should be displayed to the user.
...
- The `CoffeePlannerQuestion` component should receive the following props.

  | Key                      | Data Type |
  | -------------------------| --------- |
  | questionData             | Object    |
  | getSelectedOption        | Function  |
  | updateSelectedCoffeePlan | Function  |

- The `QuestionOption` component should receive the following props.
...
- The value to the property optionData should have the following properties.
